...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public static class DataPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            Preference button = findPreference(getString(R.string.pref_data_clear_key));
            button.setOnPreferenceClickListener(preference -> {
                new AlertDialog.Builder(getContext())
                        .setTitle(getString(R.string.pref_data_clear_confirmtitle))
                        .setMessage(getString(R.string.pref_data_clear_confirmdesc))
                        .setIcon(android.R.drawable.ic_dialog_alert)
                        .setPositiveButton(android.R.string.yes, (dialog, whichButton) -> AsyncTask.execute(() -> {
                            BazBikeDatabase bazBikeDatabase = Room
                                    .databaseBuilder(getContext(), BazBikeDatabase.class, "bazbikedb")
                                    .enableMultiInstanceInvalidation()
                                    .build();

                            bazBikeDatabase.locationGoalDao().deleteAll();
                            bazBikeDatabase.close();
